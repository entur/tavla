...
export type NearbyStopPlaceIdsQueryVariables = Exact<{
  latitude: Scalars['Float'];
  longitude: Scalars['Float'];
  maximumDistance: Scalars['Float'];
 ...
 * });
 */
export function useNearbyStopPlaceIdsQuery(baseOptions: Apollo.QueryHookOptions<NearbyStopPlaceIdsQuery, NearbyStopPlaceIdsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<NearbyStopPlaceIdsQuery, NearbyStopPlaceIdsQueryVariables>(NearbyStopPlaceIdsDocument, options);
      }
export function useNearbyStopPlaceIdsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<NearbyStopPlaceIdsQuery, NearbyStopPlaceIdsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<NearbyStopPlaceIdsQuery, NearbyStopPlaceIdsQueryVariables>(NearbyStopPlaceIdsDocument, options);
        }
export type NearbyStopPlaceIdsQueryHookResult = ReturnType<typeof useNearbyStopPlaceIdsQuery>;
export type NearbyStopPlaceIdsLazyQueryHookResult = ReturnType<typeof useNearbyStopPlaceIdsLazyQuery>;
export type NearbyStopPlaceIdsQueryResult = Apollo.QueryResult<NearbyStopPlaceIdsQuery, NearbyStopPlaceIdsQueryVariables>;
