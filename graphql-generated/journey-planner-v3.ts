...
export type GetNearestPlacesQueryVariables = Exact<{
  latitude: Scalars['Float'];
  longitude: Scalars['Float'];
  maximumDistance: Scalars['Float'];
 ...
 * });
 */
export function useGetNearestPlacesQuery(baseOptions: Apollo.QueryHookOptions<GetNearestPlacesQuery, GetNearestPlacesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetNearestPlacesQuery, GetNearestPlacesQueryVariables>(GetNearestPlacesDocument, options);
      }
export function useGetNearestPlacesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetNearestPlacesQuery, GetNearestPlacesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetNearestPlacesQuery, GetNearestPlacesQueryVariables>(GetNearestPlacesDocument, options);
        }
export type GetNearestPlacesQueryHookResult = ReturnType<typeof useGetNearestPlacesQuery>;
export type GetNearestPlacesLazyQueryHookResult = ReturnType<typeof useGetNearestPlacesLazyQuery>;
export type GetNearestPlacesQueryResult = Apollo.QueryResult<GetNearestPlacesQuery, GetNearestPlacesQueryVariables>;
