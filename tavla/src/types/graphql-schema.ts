...
export type TDepartureFragment = { aimedDepartureTime: DateTime, expectedDepartureTime: DateTime, expectedArrivalTime: DateTime, cancellation: boolean, realtime: boolean, quay: { publicCode: string | null, name: string }, destinationDisplay: { frontText: string | null, via: Array<string | null> | null } | null, serviceJourney: { id: string, transportMode: TTransportMode | null, transportSubmode: TTransportSubmode | null, line: { id: string, publicCode: string | null, presentation: { textColour: string | null, colour: string | null } | null } }, situations: Array<{ id: string, description: Array<{ value: string, language: string | null }>, summary: Array<{ value: string, language: string | null }> }> };

export type TLinesFragment = { lines: Array<{ id: string, publicCode: string | null, name: string | null, transportMode: TTransportMode | null, transportSubmode: TTransportSubmode | null }> };

export type TSituationFragment = { id: string, description: Array<{ value: string, language: string | null }>, summary: Array<{ value: string, language: string | null }> };

export type TGetQuayQueryVariables = Exact<{
  quayId: string;
  whitelistedTransportModes?: Array<TTransportMode | null | undefined> | TTransportMode | null | undefined;
...
export type TGetQuayQuery = { quay: { name: string, description: string | null, publicCode: string | null, estimatedCalls: Array<{ aimedDepartureTime: DateTime, expectedDepartureTime: DateTime, expectedArrivalTime: DateTime, cancellation: boolean, realtime: boolean, quay: { publicCode: string | null, name: string }, destinationDisplay: { frontText: string | null, via: Array<string | null> | null } | null, serviceJourney: { id: string, transportMode: TTransportMode | null, transportSubmode: TTransportSubmode | null, line: { id: string, publicCode: string | null, presentation: { textColour: string | null, colour: string | null } | null } }, situations: Array<{ id: string, description: Array<{ value: string, language: string | null }>, summary: Array<{ value: string, language: string | null }> }> }>, situations: Array<{ id: string, description: Array<{ value: string, language: string | null }>, summary: Array<{ value: string, language: string | null }> }>, lines: Array<{ id: string, publicCode: string | null, name: string | null, transportMode: TTransportMode | null, transportSubmode: TTransportSubmode | null }> } | null };
...
export type TQuayCoordinatesQuery = { quay: { id: string, longitude: number | null, latitude: number | null } | null };
...
export type TQuayEditQuery = { quay: { id: string, publicCode: string | null, name: string, lines: Array<{ id: string, publicCode: string | null, name: string | null, transportMode: TTransportMode | null, transportSubmode: TTransportSubmode | null }> } | null };

export type TQuayEstimatedCallsQueryVariables = Exact<{
  quayId: string;
  numberOfDepartures?: number | null | undefined;
  arrivalDeparture?: TArrivalDeparture | null | undefined;
}>;


export type TQuayEstimatedCallsQuery = { quay: { estimatedCalls: Array<{ destinationDisplay: { frontText: string | null } | null, serviceJourney: { line: { id: string } } }> } | null };
...
export type TQuayNameQuery = { quay: { name: string, description: string | null, publicCode: string | null, id: string } | null };
...
export type TQuaysSearchQuery = { stopPlace: { quays: Array<{ id: string, publicCode: string | null, description: string | null, stopPlace: { transportMode: Array<TTransportMode | null> | null } | null, lines: Array<{ id: string, publicCode: string | null, name: string | null, transportMode: TTransportMode | null, transportSubmode: TTransportSubmode | null }> } | null> | null } | null };
...
export type TStopPlaceQuery = { stopPlace: { name: string, transportMode: Array<TTransportMode | null> | null, estimatedCalls: Array<{ aimedDepartureTime: DateTime, expectedDepartureTime: DateTime, expectedArrivalTime: DateTime, cancellation: boolean, realtime: boolean, quay: { publicCode: string | null, name: string }, destinationDisplay: { frontText: string | null, via: Array<string | null> | null } | null, serviceJourney: { id: string, transportMode: TTransportMode | null, transportSubmode: TTransportSubmode | null, line: { id: string, publicCode: string | null, presentation: { textColour: string | null, colour: string | null } | null } }, situations: Array<{ id: string, description: Array<{ value: string, language: string | null }>, summary: Array<{ value: string, language: string | null }> }> }>, situations: Array<{ id: string, description: Array<{ value: string, language: string | null }>, summary: Array<{ value: string, language: string | null }> }> } | null };
...
export type TStopPlaceCoordinatesQuery = { stopPlace: { id: string, longitude: number | null, latitude: number | null } | null };
...
export type TStopPlaceEditQuery = { stopPlace: { name: string, quays: Array<{ id: string, publicCode: string | null, name: string, description: string | null, stopPlace: { transportMode: Array<TTransportMode | null> | null } | null, lines: Array<{ id: string, publicCode: string | null, name: string | null, transportMode: TTransportMode | null, transportSubmode: TTransportSubmode | null }> } | null> | null } | null };
...
export type TStopPlaceNameQuery = { stopPlace: { name: string, id: string } | null };
...
export type TStopPlacesHaveDeparturesQuery = { stopPlaces: Array<{ id: string, quays: Array<{ lines: Array<{ transportMode: TTransportMode | null, transportSubmode: TTransportSubmode | null }> } | null> | null } | null> };
...
export type TWalkDistanceQuery = { trip: { tripPatterns: Array<{ duration: Long | null, streetDistance: number | null, legs: Array<{ expectedStartTime: DateTime, expectedEndTime: DateTime, mode: TMode, distance: number, line: { id: string, publicCode: string | null } | null }> }> } };
