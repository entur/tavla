...
import { userCanEditBoard } from 'app/(root)/(admin)/utils/firebase'
import { Open } from './components/Buttons/Open'
import { Copy } from './components/Buttons/Copy'
import { Footer } from './components/Footer'
import { RefreshButton } from './components/RefreshButton'
import { DEFAULT_BOARD_NAME } from 'app/(root)/(admin)/utils/constants'
...
import { Delete } from 'app/(root)/(admin)/boards/components/Column/Delete'
