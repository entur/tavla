...
function Logo({ height, width, colorTheme }) {
    let fontColor
    switch (colorTheme) {
        case 'light':
            fontColor = '#181C56'
            ...
            <div>
                ...
                >
                    <g fill="none" fillRule="evenodd">
                        <path fill={fontColor} d="M1 0v13.006h9.392v-2.203H3.439V7.658h6.169V5.455H3.439V2.203h6.953V0z"/>
                ...
                <p>Finn din rute på en-tur.no</p>
            </div>
        </div>
    )
}
