        ...
        <article className="privacy">
            ...
            <div className="privacy__body">
                ...
                <Paragraph>
                    ...
                    forskjellige tilganger til nettleseren din. Entur-appen kan
                    be om følgende tilganger:
                </Paragraph>
                ...
                <Paragraph>
                    ...
                    logge kræsjrapporter når noe går galt på Tavla. Dette bruker
                    vi til å enklere oppdage og rette feil som oppstår i koden.
                </Paragraph>
                <Paragraph>
                    Feilrapportene vi mottar inneholder informasjon om hvilken
                    nettleser og hvilket operativsystem du bruker. Vi lagrer
                    ikke IP-adresser.
                </Paragraph>
            </div>
        </article>
