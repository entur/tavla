...
module.exports = {
    forbidden: [
        /* rules from the 'recommended' preset: */
        {
            ...
            severity: 'error',
            comment:
                "Check that pages don't cross imports, e.g. Admin can only import within itself and from Shared.",
            from: { path: '^src/([^/]+)' },
            to: {
                pathNot: ['^src/($1|Shared)', '^node_modules'],
            },
        },
        {
            name: 'no-circular',
...
// generated: dependency-cruiser@13.0.3 on 2023-06-07T10:58:45.508Z
